...
class TestRouteTransactionsRequest(unittest.TestCase):
    """RouteTransactionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RouteTransactionsRequest:
        """Test RouteTransactionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RouteTransactionsRequest`
        """
        model = RouteTransactionsRequest()
        if include_optional:
            return RouteTransactionsRequest(
                reservation_id = 56,
                group_profile_id = 56,
                target_folio_id = 56,
                transactions = [
                ...
                transaction_types = [
                    cloudbeds_accounting.models.transaction_type_identifier.TransactionTypeIdentifier(
                        origin_id = '', 
    ...
    def testRouteTransactionsRequest(self):
        """Test RouteTransactionsRequest"""
