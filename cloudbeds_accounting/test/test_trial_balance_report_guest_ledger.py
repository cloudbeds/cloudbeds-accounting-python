...
class TestTrialBalanceReportGuestLedger(unittest.TestCase):
    """TrialBalanceReportGuestLedger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrialBalanceReportGuestLedger:
        """Test TrialBalanceReportGuestLedger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrialBalanceReportGuestLedger`
        """
        model = TrialBalanceReportGuestLedger()
        if include_optional:
            return TrialBalanceReportGuestLedger(
                charges = [
    ...
    def testTrialBalanceReportGuestLedger(self):
        """Test TrialBalanceReportGuestLedger"""
