...
class TestFolioTransactionGroupTotals(unittest.TestCase):
    """FolioTransactionGroupTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioTransactionGroupTotals:
        """Test FolioTransactionGroupTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioTransactionGroupTotals`
        """
        model = FolioTransactionGroupTotals()
        if include_optional:
            return FolioTransactionGroupTotals(
                count = 56,
                quantity = 56,
                total_debit = 1.337,
                total_credit = 1.337
    ...
    def testFolioTransactionGroupTotals(self):
        """Test FolioTransactionGroupTotals"""
