...
class TestTransactionTypeIdentifier(unittest.TestCase):
    """TransactionTypeIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionTypeIdentifier:
        """Test TransactionTypeIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionTypeIdentifier`
        """
        model = TransactionTypeIdentifier()
        if include_optional:
    ...
    def testTransactionTypeIdentifier(self):
        """Test TransactionTypeIdentifier"""
