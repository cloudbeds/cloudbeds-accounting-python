...
class TestExternalRelationKind(unittest.TestCase):
    """ExternalRelationKind unit test stubs"""
    ...
    def testExternalRelationKind(self):
        """Test ExternalRelationKind"""
        # inst = ExternalRelationKind()
