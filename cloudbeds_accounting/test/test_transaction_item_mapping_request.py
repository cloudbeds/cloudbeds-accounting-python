...
class TestTransactionItemMappingRequest(unittest.TestCase):
    """TransactionItemMappingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionItemMappingRequest:
        """Test TransactionItemMappingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionItemMappingRequest`
        """
        model = TransactionItemMappingRequest()
        if include_optional:
            return TransactionItemMappingRequest(
                data = [
                    cloudbeds_accounting.models.transaction_item_mapping_update_model.TransactionItemMappingUpdateModel(
                        id = '', 
                        code = '0', 
                        account_id = '', )
                    ]
    ...
    def testTransactionItemMappingRequest(self):
        """Test TransactionItemMappingRequest"""
