...
class TestFolioConfigurationSaveResponseData(unittest.TestCase):
    """FolioConfigurationSaveResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioConfigurationSaveResponseData:
        """Test FolioConfigurationSaveResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioConfigurationSaveResponseData`
        """
        model = FolioConfigurationSaveResponseData()
        if include_optional:
            return FolioConfigurationSaveResponseData(
                id = ''
            )
        else:
            return FolioConfigurationSaveResponseData(
    ...
    def testFolioConfigurationSaveResponseData(self):
        """Test FolioConfigurationSaveResponseData"""
