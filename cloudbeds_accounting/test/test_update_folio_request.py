...
class TestUpdateFolioRequest(unittest.TestCase):
    """UpdateFolioRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFolioRequest:
        """Test UpdateFolioRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFolioRequest`
        """
        model = UpdateFolioRequest()
        if include_optional:
            return UpdateFolioRequest(
                name = '',
                transaction_types = [
    ...
    def testUpdateFolioRequest(self):
        """Test UpdateFolioRequest"""
