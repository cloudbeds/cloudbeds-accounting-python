...
class TestFoliosApi(unittest.TestCase):
    """FoliosApi unit test stubs"""
    ...
    def test_create_folio(self) -> None:
        """Test case for create_folio

        Create a folio
        """
        pass

    def test_delete_folio(self) -> None:
        """Test case for delete_folio

        Delete a folio
        """
        pass

    def test_get_folios(self) -> None:
        """Test case for get_folios

        List folios for a source
        """
        pass

    def test_list_folio_transactions(self) -> None:
        """Test case for list_folio_transactions
    ...
    def test_route_transactions(self) -> None:
        """Test case for route_transactions

        Route transactions to a group profile
        """
        pass

    def test_unroute_transactions(self) -> None:
        """Test case for unroute_transactions

        Unroute transactions from a group profile
        """
        pass

    def test_update_folio(self) -> None:
        """Test case for update_folio
