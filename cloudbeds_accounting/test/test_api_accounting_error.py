...
class TestApiAccountingError(unittest.TestCase):
    """ApiAccountingError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiAccountingError:
        """Test ApiAccountingError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiAccountingError`
        """
        model = ApiAccountingError()
        if include_optional:
    ...
    def testApiAccountingError(self):
        """Test ApiAccountingError"""
