...
class TestFolioConfigurationSourceData(unittest.TestCase):
    """FolioConfigurationSourceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioConfigurationSourceData:
        """Test FolioConfigurationSourceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioConfigurationSourceData`
        """
        model = FolioConfigurationSourceData()
        if include_optional:
            return FolioConfigurationSourceData(
                source_id = 56,
                is_root_source = True,
    ...
    def testFolioConfigurationSourceData(self):
        """Test FolioConfigurationSourceData"""
