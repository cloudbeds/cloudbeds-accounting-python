...
class TestFiscalDocumentSummary(unittest.TestCase):
    """FiscalDocumentSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FiscalDocumentSummary:
        """Test FiscalDocumentSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FiscalDocumentSummary`
        """
        model = FiscalDocumentSummary()
        if include_optional:
            return FiscalDocumentSummary(
                id = '',
                number = '',
                kind = 'INVOICE',
    ...
    def testFiscalDocumentSummary(self):
        """Test FiscalDocumentSummary"""
