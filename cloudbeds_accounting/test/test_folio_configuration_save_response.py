...
class TestFolioConfigurationSaveResponse(unittest.TestCase):
    """FolioConfigurationSaveResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioConfigurationSaveResponse:
        """Test FolioConfigurationSaveResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioConfigurationSaveResponse`
        """
        model = FolioConfigurationSaveResponse()
        if include_optional:
            return FolioConfigurationSaveResponse(
                data = cloudbeds_accounting.models.folio_configuration_save_response_data.FolioConfigurationSaveResponseData(
                    id = '', )
            )
        else:
            return FolioConfigurationSaveResponse(
    ...
    def testFolioConfigurationSaveResponse(self):
        """Test FolioConfigurationSaveResponse"""
