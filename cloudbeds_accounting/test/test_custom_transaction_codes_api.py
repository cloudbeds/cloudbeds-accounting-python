...
class TestCustomTransactionCodesApi(unittest.TestCase):
    """CustomTransactionCodesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CustomTransactionCodesApi()

    def tearDown(self) -> None:
        pass

    def test_get_custom_transaction_codes(self) -> None:
        """Test case for get_custom_transaction_codes

        List custom transaction codes
        """
        pass

    def test_initialize_custom_transaction_codes(self) -> None:
        """Test case for initialize_custom_transaction_codes

        Initialize custom transaction codes
        """
        pass

    def test_put_custom_transaction_codes(self) -> None:
        """Test case for put_custom_transaction_codes
