...
class TestCreateFolioResponse(unittest.TestCase):
    """CreateFolioResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFolioResponse:
        """Test CreateFolioResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFolioResponse`
        """
        model = CreateFolioResponse()
        if include_optional:
            return CreateFolioResponse(
                id = 56
            )
        else:
            return CreateFolioResponse(
    ...
    def testCreateFolioResponse(self):
        """Test CreateFolioResponse"""
