...
class TestUnrouteTransactionsRequest(unittest.TestCase):
    """UnrouteTransactionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnrouteTransactionsRequest:
        """Test UnrouteTransactionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnrouteTransactionsRequest`
        """
        model = UnrouteTransactionsRequest()
        if include_optional:
            return UnrouteTransactionsRequest(
                transactions = [
                    56
                    ]
            )
    ...
    def testUnrouteTransactionsRequest(self):
        """Test UnrouteTransactionsRequest"""
