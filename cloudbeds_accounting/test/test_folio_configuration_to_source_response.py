...
class TestFolioConfigurationToSourceResponse(unittest.TestCase):
    """FolioConfigurationToSourceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioConfigurationToSourceResponse:
        """Test FolioConfigurationToSourceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioConfigurationToSourceResponse`
        """
        model = FolioConfigurationToSourceResponse()
        if include_optional:
            return FolioConfigurationToSourceResponse(
                source_id = '',
                source_kind = 'CONFIG',
    ...
    def testFolioConfigurationToSourceResponse(self):
        """Test FolioConfigurationToSourceResponse"""
