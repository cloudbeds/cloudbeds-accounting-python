...
class TestFolioTransactionTypeResponse(unittest.TestCase):
    """FolioTransactionTypeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioTransactionTypeResponse:
        """Test FolioTransactionTypeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioTransactionTypeResponse`
        """
        model = FolioTransactionTypeResponse()
        if include_optional:
            return FolioTransactionTypeResponse(
                origin_id = '',
    ...
    def testFolioTransactionTypeResponse(self):
        """Test FolioTransactionTypeResponse"""
