...
class TestFolioTransactionTotals(unittest.TestCase):
    """FolioTransactionTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioTransactionTotals:
        """Test FolioTransactionTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioTransactionTotals`
        """
        model = FolioTransactionTotals()
        if include_optional:
            return FolioTransactionTotals(
                count = 56,
                total_debit = 1.337,
                total_credit = 1.337,
                currency = '',
    ...
    def testFolioTransactionTotals(self):
        """Test FolioTransactionTotals"""
