...
class TestMoveTransactionsRequest(unittest.TestCase):
    """MoveTransactionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveTransactionsRequest:
        """Test MoveTransactionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveTransactionsRequest`
        """
        model = MoveTransactionsRequest()
        if include_optional:
            return MoveTransactionsRequest(
    ...
    def testMoveTransactionsRequest(self):
        """Test MoveTransactionsRequest"""
