...
class TestForeignCurrencyTotals(unittest.TestCase):
    """ForeignCurrencyTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForeignCurrencyTotals:
        """Test ForeignCurrencyTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForeignCurrencyTotals`
        """
        model = ForeignCurrencyTotals()
        if include_optional:
            return ForeignCurrencyTotals(
                debit = {
                    'key' : 1.337
                    },
                credit = {
    ...
    def testForeignCurrencyTotals(self):
        """Test ForeignCurrencyTotals"""
