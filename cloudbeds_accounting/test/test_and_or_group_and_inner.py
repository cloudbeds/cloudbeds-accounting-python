...
class TestAndOrGroupAndInner(unittest.TestCase):
    """AndOrGroupAndInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AndOrGroupAndInner:
        """Test AndOrGroupAndInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AndOrGroupAndInner`
        """
        model = AndOrGroupAndInner()
        if include_optional:
            return AndOrGroupAndInner(
                var_and = [
                    null
                    ],
                var_or = [
                ...
                value = cloudbeds_accounting.models.value.value(),
                var_field = ''
            )
        else:
            return AndOrGroupAndInner(
    ...
    def testAndOrGroupAndInner(self):
        """Test AndOrGroupAndInner"""
