...
class TestAccountsReceivableLedgerReservationBalanceTransferResponseTransaction(unittest.TestCase):
    """AccountsReceivableLedgerReservationBalanceTransferResponseTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountsReceivableLedgerReservationBalanceTransferResponseTransaction:
        """Test AccountsReceivableLedgerReservationBalanceTransferResponseTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountsReceivableLedgerReservationBalanceTransferResponseTransaction`
        """
        model = AccountsReceivableLedgerReservationBalanceTransferResponseTransaction()
        if include_optional:
            return AccountsReceivableLedgerReservationBalanceTransferResponseTransaction(
                id = '',
                amount = 1.337
            )
        else:
    ...
    def testAccountsReceivableLedgerReservationBalanceTransferResponseTransaction(self):
        """Test AccountsReceivableLedgerReservationBalanceTransferResponseTransaction"""
