...
class TestFolioConfigurationFolioTransactionTypeData(unittest.TestCase):
    """FolioConfigurationFolioTransactionTypeData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioConfigurationFolioTransactionTypeData:
        """Test FolioConfigurationFolioTransactionTypeData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioConfigurationFolioTransactionTypeData`
        """
        model = FolioConfigurationFolioTransactionTypeData()
        if include_optional:
            return FolioConfigurationFolioTransactionTypeData(
                folio_id = 56,
                transaction_type = ''
            )
        else:
    ...
    def testFolioConfigurationFolioTransactionTypeData(self):
        """Test FolioConfigurationFolioTransactionTypeData"""
