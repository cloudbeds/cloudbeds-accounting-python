...
class TestAsyncEventResponse(unittest.TestCase):
    """AsyncEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsyncEventResponse:
        """Test AsyncEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsyncEventResponse`
        """
    ...
    def testAsyncEventResponse(self):
        """Test AsyncEventResponse"""
