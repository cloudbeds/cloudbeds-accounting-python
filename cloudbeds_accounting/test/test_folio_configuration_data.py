...
class TestFolioConfigurationData(unittest.TestCase):
    """FolioConfigurationData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioConfigurationData:
        """Test FolioConfigurationData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioConfigurationData`
        """
        model = FolioConfigurationData()
        if include_optional:
            return FolioConfigurationData(
                id = 56,
                name = '',
                description = '',
                is_default = True,
                ...
                sources = [
                    cloudbeds_accounting.models.folio_configuration_source_data.FolioConfigurationSourceData(
                        source_id = 56, 
                        is_root_source = True, 
                        is_hotel_collect_booking = True, )
                    ],
                folios = [
                    cloudbeds_accounting.models.folio_configuration_folio_data.FolioConfigurationFolioData(
                        id = 56, 
                        folio_name = '', 
                        link_type = 56, 
                        transaction_types = [
                            cloudbeds_accounting.models.folio_configuration_folio_transaction_type_data.FolioConfigurationFolioTransactionTypeData(
                                folio_id = 56, 
                                transaction_type = '', )
                            ], )
                    ]
    ...
    def testFolioConfigurationData(self):
        """Test FolioConfigurationData"""
