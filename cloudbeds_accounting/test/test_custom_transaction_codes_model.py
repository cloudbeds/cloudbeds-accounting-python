...
class TestCustomTransactionCodesModel(unittest.TestCase):
    """CustomTransactionCodesModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomTransactionCodesModel:
        """Test CustomTransactionCodesModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomTransactionCodesModel`
        """
        model = CustomTransactionCodesModel()
        if include_optional:
    ...
    def testCustomTransactionCodesModel(self):
        """Test CustomTransactionCodesModel"""
