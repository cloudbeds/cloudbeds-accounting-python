...
class TestFolioPaymentAllocation(unittest.TestCase):
    """FolioPaymentAllocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioPaymentAllocation:
        """Test FolioPaymentAllocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioPaymentAllocation`
        """
        model = FolioPaymentAllocation()
        if include_optional:
            return FolioPaymentAllocation(
                id = 56,
                allocated_amount = 56,
                transaction_id = '',
                description = '',
    ...
    def testFolioPaymentAllocation(self):
        """Test FolioPaymentAllocation"""
