...
class TestGetFoliosFilterParameter(unittest.TestCase):
    """GetFoliosFilterParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFoliosFilterParameter:
        """Test GetFoliosFilterParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFoliosFilterParameter`
        """
        model = GetFoliosFilterParameter()
        if include_optional:
            return GetFoliosFilterParameter(
                source_id = 56,
                source_kind = 'CONFIG'
            )
        else:
    ...
    def testGetFoliosFilterParameter(self):
        """Test GetFoliosFilterParameter"""
