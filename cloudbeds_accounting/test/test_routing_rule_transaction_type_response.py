...
class TestRoutingRuleTransactionTypeResponse(unittest.TestCase):
    """RoutingRuleTransactionTypeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingRuleTransactionTypeResponse:
        """Test RoutingRuleTransactionTypeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingRuleTransactionTypeResponse`
        """
        model = RoutingRuleTransactionTypeResponse()
        if include_optional:
            return RoutingRuleTransactionTypeResponse(
    ...
    def testRoutingRuleTransactionTypeResponse(self):
        """Test RoutingRuleTransactionTypeResponse"""
