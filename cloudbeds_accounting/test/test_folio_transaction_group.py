...
class TestFolioTransactionGroup(unittest.TestCase):
    """FolioTransactionGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioTransactionGroup:
        """Test FolioTransactionGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioTransactionGroup`
        """
        model = FolioTransactionGroup()
        if include_optional:
            return FolioTransactionGroup(
                transactions = [
    ...
    def testFolioTransactionGroup(self):
        """Test FolioTransactionGroup"""
