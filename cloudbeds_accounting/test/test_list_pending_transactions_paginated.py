...
class TestListPendingTransactionsPaginated(unittest.TestCase):
    """ListPendingTransactionsPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPendingTransactionsPaginated:
        """Test ListPendingTransactionsPaginated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPendingTransactionsPaginated`
        """
        model = ListPendingTransactionsPaginated()
        if include_optional:
            return ListPendingTransactionsPaginated(
                transactions = [
    ...
    def testListPendingTransactionsPaginated(self):
        """Test ListPendingTransactionsPaginated"""
