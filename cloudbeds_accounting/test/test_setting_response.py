...
class TestSettingResponse(unittest.TestCase):
    """SettingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SettingResponse:
        """Test SettingResponse
