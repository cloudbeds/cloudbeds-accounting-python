...
class TestFolioConfigurationFolioData(unittest.TestCase):
    """FolioConfigurationFolioData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolioConfigurationFolioData:
        """Test FolioConfigurationFolioData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolioConfigurationFolioData`
        """
        model = FolioConfigurationFolioData()
        if include_optional:
            return FolioConfigurationFolioData(
                id = 56,
                folio_name = '',
                link_type = 56,
                transaction_types = [
    ...
    def testFolioConfigurationFolioData(self):
        """Test FolioConfigurationFolioData"""
