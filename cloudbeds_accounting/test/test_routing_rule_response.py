...
class TestRoutingRuleResponse(unittest.TestCase):
    """RoutingRuleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingRuleResponse:
        """Test RoutingRuleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingRuleResponse`
        """
        model = RoutingRuleResponse()
        if include_optional:
            return RoutingRuleResponse(
                ...
                enabled = True,
                transaction_types = [
                    cloudbeds_accounting.models.routing_rule_transaction_type_response.RoutingRuleTransactionTypeResponse(
    ...
    def testRoutingRuleResponse(self):
        """Test RoutingRuleResponse"""
