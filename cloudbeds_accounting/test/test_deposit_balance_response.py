...
class TestDepositBalanceResponse(unittest.TestCase):
    """DepositBalanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepositBalanceResponse:
        """Test DepositBalanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepositBalanceResponse`
        """
        model = DepositBalanceResponse()
        if include_optional:
            return DepositBalanceResponse(
                posted_balance = 1.337,
    ...
    def testDepositBalanceResponse(self):
        """Test DepositBalanceResponse"""
