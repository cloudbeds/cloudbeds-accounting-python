...
class TestListFolioTransactionsPaginated(unittest.TestCase):
    """ListFolioTransactionsPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFolioTransactionsPaginated:
        """Test ListFolioTransactionsPaginated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFolioTransactionsPaginated`
        """
        model = ListFolioTransactionsPaginated()
        if include_optional:
            return ListFolioTransactionsPaginated(
                groups = {
                    'key' : cloudbeds_accounting.models.folio_transaction_group.FolioTransactionGroup(
                        transactions = [
                            cloudbeds_accounting.models.folio_transaction_response.FolioTransactionResponse(
                                id = '', 
                                property_id = '', 
                                amount = 1.337, 
                                currency = '', 
                        ...
                        totals = cloudbeds_accounting.models.folio_transaction_group_totals.FolioTransactionGroupTotals(
                            count = 56, 
                            quantity = 56, 
                            total_debit = 1.337, 
                            total_credit = 1.337, ), )
                ...
                next_page_token = '',
                totals = cloudbeds_accounting.models.folio_transaction_totals.FolioTransactionTotals(
                    count = 56, 
                    total_debit = 1.337, 
                    total_credit = 1.337, 
                    currency = '', 
                    currency_scale = 56, ),
                foreign_currency_totals = cloudbeds_accounting.models.foreign_currency_totals.ForeignCurrencyTotals(
                    debit = {
                        'key' : 1.337
                        }, 
                    credit = {
    ...
    def testListFolioTransactionsPaginated(self):
        """Test ListFolioTransactionsPaginated"""
