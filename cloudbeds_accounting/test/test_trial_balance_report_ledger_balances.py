...
class TestTrialBalanceReportLedgerBalances(unittest.TestCase):
    """TrialBalanceReportLedgerBalances unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrialBalanceReportLedgerBalances:
        """Test TrialBalanceReportLedgerBalances
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrialBalanceReportLedgerBalances`
        """
        model = TrialBalanceReportLedgerBalances()
        if include_optional:
            return TrialBalanceReportLedgerBalances(
                deposit_ledger = [
    ...
    def testTrialBalanceReportLedgerBalances(self):
        """Test TrialBalanceReportLedgerBalances"""
