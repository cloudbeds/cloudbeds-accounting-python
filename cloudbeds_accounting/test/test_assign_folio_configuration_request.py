...
class TestAssignFolioConfigurationRequest(unittest.TestCase):
    """AssignFolioConfigurationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignFolioConfigurationRequest:
        """Test AssignFolioConfigurationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignFolioConfigurationRequest`
        """
        model = AssignFolioConfigurationRequest()
        if include_optional:
            return AssignFolioConfigurationRequest(
                config_id = 56,
                source_id = 56,
                source_kind = 'CONFIG'
            )
    ...
    def testAssignFolioConfigurationRequest(self):
        """Test AssignFolioConfigurationRequest"""
