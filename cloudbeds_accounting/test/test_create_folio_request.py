...
class TestCreateFolioRequest(unittest.TestCase):
    """CreateFolioRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFolioRequest:
        """Test CreateFolioRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFolioRequest`
        """
        model = CreateFolioRequest()
        if include_optional:
            return CreateFolioRequest(
                name = '',
                folio_configuration_id = 56,
                parent_id = 56,
                source_id = 56,
                source_kind = 'CONFIG',
                transaction_types = [
    ...
    def testCreateFolioRequest(self):
        """Test CreateFolioRequest"""
