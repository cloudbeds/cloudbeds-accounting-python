...
class FolioConfigurationSourceData(BaseModel):
    """
    FolioConfigurationSourceData
    """ # noqa: E501
    source_id: Optional[StrictInt] = Field(default=None, description="Booking source ID", alias="sourceId")
    is_root_source: Optional[StrictBool] = Field(default=None, alias="isRootSource")
    is_hotel_collect_booking: Optional[StrictBool] = Field(default=None, alias="isHotelCollectBooking")
    __properties: ClassVar[List[str]] = ["sourceId", "isRootSource", "isHotelCollectBooking"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isRootSource": obj.get("isRootSource"),
            "isHotelCollectBooking": obj.get("isHotelCollectBooking")
        })
        return _obj
