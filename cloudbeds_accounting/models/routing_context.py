...
class RoutingContext(BaseModel):
    ...
    """ # noqa: E501
    group_profile_id: Optional[StrictStr] = Field(default=None, alias="groupProfileId")
    group_profile_name: Optional[StrictStr] = Field(default=None, alias="groupProfileName")
    group_profile_identifier: Optional[StrictStr] = Field(default=None, alias="groupProfileIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["groupProfileId", "groupProfileName", "groupProfileIdentifier", "reservationId", "reservationName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groupProfileName": obj.get("groupProfileName"),
            "groupProfileIdentifier": obj.get("groupProfileIdentifier"),
