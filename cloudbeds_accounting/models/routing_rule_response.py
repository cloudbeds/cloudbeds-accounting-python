...
class RoutingRuleResponse(BaseModel):
    ...
    RoutingRuleResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Routing rule ID")
    property_id: Optional[StrictStr] = Field(default=None, description="Property ID", alias="propertyId")
    source_id: Optional[StrictStr] = Field(default=None, description="Source ID (e.g., Group Profile ID)", alias="sourceId")
    source_kind: Optional[FolioSourceKind] = Field(default=None, alias="sourceKind")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether the rule is enabled")
    transaction_types: Optional[List[RoutingRuleTransactionTypeResponse]] = Field(default=None, alias="transactionTypes")
    __properties: ClassVar[List[str]] = ["id", "propertyId", "sourceId", "sourceKind", "enabled", "transactionTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactionTypes": [RoutingRuleTransactionTypeResponse.from_dict(_item) for _item in obj["transactionTypes"]] if obj.get("transactionTypes") is not None else None
        })
        return _obj
