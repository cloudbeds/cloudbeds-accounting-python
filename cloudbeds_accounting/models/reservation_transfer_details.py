...
class ReservationTransferDetails(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Reservation ID.")
    identifier: Optional[StrictStr] = Field(default=None, description="Reservation Identifier.")
    ...
    checkout_date: Optional[date] = Field(default=None, description="Checkout in date.", alias="checkoutDate")
    __properties: ClassVar[List[str]] = ["id", "identifier", "guestName", "status", "checkinDate", "checkoutDate"]
