...
class FiscalDocumentSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "number", "kind", "createdAt"]
    ...
    def kind_validate_enum(cls, value):
        ...
        _allowed_values = set(['INVOICE', 'CREDIT_NOTE', 'RECEIPT', 'RECTIFY_INVOICE', 'PRO_FORMA_INVOICE', 'REFUND_RECEIPT', 'INVOICE_RECEIPT', 'unknown_default_open_api'])
