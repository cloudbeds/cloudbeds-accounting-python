...
class FolioPaymentAllocation(BaseModel):
    """
    FolioPaymentAllocation
    """ # noqa: E501
    id: Optional[StrictInt] = None
    allocated_amount: Optional[StrictInt] = Field(default=None, description="Amount allocated in smallest currency unit", alias="allocatedAmount")
    transaction_id: Optional[StrictStr] = Field(default=None, description="ID of the transaction (invoice/expense) this payment is allocated to", alias="transactionId")
    description: Optional[StrictStr] = Field(default=None, description="Description of the allocated transaction")
    total_to_allocate: Optional[StrictInt] = Field(default=None, description="Total amount of the allocated transaction in smallest currency unit", alias="totalToAllocate")
    __properties: ClassVar[List[str]] = ["id", "allocatedAmount", "transactionId", "description", "totalToAllocate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalToAllocate": obj.get("totalToAllocate")
        })
        return _obj
