...
class AsyncEventResponse(BaseModel):
    ...
    AsyncEventResponse
    """ # noqa: E501
    event_id: Optional[StrictStr] = Field(default=None, description="Id of event which will be processed asynchronous.", alias="eventId")
    __properties: ClassVar[List[str]] = ["eventId"]
