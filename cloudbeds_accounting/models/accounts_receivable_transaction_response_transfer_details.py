...
class AccountsReceivableTransactionResponseTransferDetails(BaseModel):
    """
    Reservation or Group Profile details for which the transfer was made.
    """ # noqa: E501
    reservation: Optional[ReservationTransferDetails] = None
    group_profile: Optional[GroupProfileTransferDetails] = Field(default=None, alias="groupProfile")
    __properties: ClassVar[List[str]] = ["reservation", "groupProfile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of group_profile
        if self.group_profile:
            _dict['groupProfile'] = self.group_profile.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reservation": ReservationTransferDetails.from_dict(obj["reservation"]) if obj.get("reservation") is not None else None,
            "groupProfile": GroupProfileTransferDetails.from_dict(obj["groupProfile"]) if obj.get("groupProfile") is not None else None
        })
        return _obj
