...
class TrialBalanceConfigurationStatusResponse(BaseModel):
    """
    TrialBalanceConfigurationStatusResponse
    """ # noqa: E501
    configured_at: Optional[StrictStr] = Field(default=None, description="Configured datetime (ISO 8601) in UTC", alias="configuredAt")
    configured: Optional[StrictBool] = Field(default=None, description="True if this property has configured trial balance. ")
    __properties: ClassVar[List[str]] = ["configuredAt", "configured"]
