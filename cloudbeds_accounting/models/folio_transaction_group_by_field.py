...
class FolioTransactionGroupByField(str, Enum):
    """
    ...
    internal_code_group = 'internal_code_group'
    description = 'description'
    sub_source_identifier = 'sub_source_identifier'
    folio_id = 'folio_id'
    user_id = 'user_id'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FolioTransactionGroupByField from a JSON string"""
