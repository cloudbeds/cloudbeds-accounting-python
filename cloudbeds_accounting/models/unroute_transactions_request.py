...
class UnrouteTransactionsRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    transactions: Annotated[List[StrictInt], Field(min_length=1)] = Field(description="List of transaction IDs to unroute from the group profile.")
