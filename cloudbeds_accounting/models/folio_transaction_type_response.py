...
class FolioTransactionTypeResponse(BaseModel):
    """
    FolioTransactionTypeResponse
    """ # noqa: E501
    origin_id: Optional[StrictStr] = Field(default=None, description="Origin ID of the transaction type", alias="originId")
    external_relation_kind: Optional[ExternalRelationKind] = Field(default=None, alias="externalRelationKind")
    __properties: ClassVar[List[str]] = ["originId", "externalRelationKind"]
