...
class FolioTransactionGroup(BaseModel):
    """
    FolioTransactionGroup
    """ # noqa: E501
    transactions: Optional[List[FolioTransactionResponse]] = None
    totals: Optional[FolioTransactionGroupTotals] = None
    __properties: ClassVar[List[str]] = ["transactions", "totals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [FolioTransactionResponse.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None,
            "totals": FolioTransactionGroupTotals.from_dict(obj["totals"]) if obj.get("totals") is not None else None
        })
        return _obj
