...
class TrialBalanceReportGuestLedger(BaseModel):
    """
    TrialBalanceReportGuestLedger
    """ # noqa: E501
    charges: Optional[List[TrialBalanceReportCodeInfo]] = None
    taxes: Optional[List[TrialBalanceReportCodeInfo]] = None
    payments: Optional[List[TrialBalanceReportCodeInfo]] = None
    __properties: ClassVar[List[str]] = ["charges", "taxes", "payments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "charges": [TrialBalanceReportCodeInfo.from_dict(_item) for _item in obj["charges"]] if obj.get("charges") is not None else None,
            "taxes": [TrialBalanceReportCodeInfo.from_dict(_item) for _item in obj["taxes"]] if obj.get("taxes") is not None else None,
            "payments": [TrialBalanceReportCodeInfo.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None
        })
        return _obj
