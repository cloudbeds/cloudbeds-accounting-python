...
class Action(BaseModel):
    ...
    Action
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of Action")
    parameters: Optional[Dict[str, StrictStr]] = Field(default=None, description="Parameters required for the action, can be any object. ")
