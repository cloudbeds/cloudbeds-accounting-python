...
class TransactionTypeIdentifier(BaseModel):
    """
    TransactionTypeIdentifier
    """ # noqa: E501
    origin_id: StrictStr = Field(description="Origin ID of the transaction type", alias="originId")
    external_relation_kind: ExternalRelationKind = Field(alias="externalRelationKind")
