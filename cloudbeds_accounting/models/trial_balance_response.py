...
class TrialBalanceResponse(BaseModel):
    ...
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, description="Date of the trial balance.", alias="date")
    deposits_ledger_opening_balance: Optional[StrictInt] = Field(default=None, alias="depositsLedgerOpeningBalance")
    accounts_receivable_ledger_opening_balance: Optional[StrictInt] = Field(default=None, alias="accountsReceivableLedgerOpeningBalance")
    guest_ledger_opening_balance: Optional[StrictInt] = Field(default=None, alias="guestLedgerOpeningBalance")
    __properties: ClassVar[List[str]] = ["date", "depositsLedgerOpeningBalance", "accountsReceivableLedgerOpeningBalance", "guestLedgerOpeningBalance"]
