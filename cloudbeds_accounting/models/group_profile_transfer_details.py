...
class GroupProfileTransferDetails(BaseModel):
    """
    GroupProfileTransferDetails
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Group Profile ID.")
    name: Optional[StrictStr] = Field(default=None, description="Group Profile Name.")
    code: Optional[StrictStr] = Field(default=None, description="Group Profile Code.")
