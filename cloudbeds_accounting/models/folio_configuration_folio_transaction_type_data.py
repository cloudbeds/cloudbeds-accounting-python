...
class FolioConfigurationFolioTransactionTypeData(BaseModel):
    """
    FolioConfigurationFolioTransactionTypeData
    """ # noqa: E501
    folio_id: Optional[StrictInt] = Field(default=None, alias="folioId")
    transaction_type: Optional[StrictStr] = Field(default=None, alias="transactionType")
    __properties: ClassVar[List[str]] = ["folioId", "transactionType"]
