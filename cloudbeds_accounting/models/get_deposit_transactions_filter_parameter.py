...
class GetDepositTransactionsFilterParameter(BaseModel):
    """
    ...
    include_inactive: Optional[StrictBool] = Field(default=True, description="Include inactive transactions (voided, consumed, cancelled, deleted)", alias="includeInactive")
    ...
    __properties: ClassVar[List[str]] = ["transactionStates", "includeInactive", "reservationId", "transactionDateFrom", "transactionDateTo", "checkinDateFrom", "checkinDateTo", "checkoutDateFrom", "checkoutDateTo", "reservationStatus", "userId", "sortBy", "sortDirection"]
    ...
    def sort_by_validate_enum(cls, value):
        ...
        _allowed_values = set(['CHECKOUT_DATE', 'CHECKIN_DATE', 'TRANSACTION_DATE', 'AMOUNT', 'RESERVATION_STATUS', 'unknown_default_open_api'])
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeInactive": obj.get("includeInactive") if obj.get("includeInactive") is not None else True,
