...
class AccountsReceivableLedgerReservationBalanceTransferResponse(BaseModel):
    """
    AccountsReceivableLedgerReservationBalanceTransferResponse
    """ # noqa: E501
    transaction: Optional[AccountsReceivableLedgerReservationBalanceTransferResponseTransaction] = None
    accounts_receivable_id: Optional[StrictStr] = Field(default=None, alias="accountsReceivableId")
    __properties: ClassVar[List[str]] = ["transaction", "accountsReceivableId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction": AccountsReceivableLedgerReservationBalanceTransferResponseTransaction.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None,
            "accountsReceivableId": obj.get("accountsReceivableId")
        })
        return _obj
