...
class DepositBalanceResponse(BaseModel):
    ...
    """ # noqa: E501
    posted_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Posted balance in smallest unit according to the currency.", alias="postedBalance")
    pending_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Pending balance in smallest unit according to the currency.", alias="pendingBalance")
    __properties: ClassVar[List[str]] = ["postedBalance", "pendingBalance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "postedBalance": obj.get("postedBalance"),
