...
class Account(BaseModel):
    ...
    Account
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of account")
    ...
    chart_of_account_type: Optional[ChartOfAccountType] = Field(default=None, alias="chartOfAccountType")
    __properties: ClassVar[List[str]] = ["id", "description", "name", "category", "chartOfAccountType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chartOfAccountType": obj.get("chartOfAccountType")
        })
        return _obj
