...
class AssignFolioConfigurationRequest(BaseModel):
    """
    AssignFolioConfigurationRequest
    """ # noqa: E501
    config_id: StrictInt = Field(description="Folio configuration ID to assign", alias="configId")
    ...
    __properties: ClassVar[List[str]] = ["configId", "sourceId", "sourceKind"]
