...
class ForeignCurrencyTotals(BaseModel):
    """
    Multi-currency totals across all matching transactions (all pages).
    """ # noqa: E501
    debit: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Map of currency code to total debit amount (e.g. {\"RON\": 724.82, \"EUR\": 5})")
    credit: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Map of currency code to total credit amount")
    __properties: ClassVar[List[str]] = ["debit", "credit"]
