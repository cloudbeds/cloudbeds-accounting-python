...
class ApiAccountingError(BaseModel):
    """
    ApiAccountingError
    """ # noqa: E501
    id: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    error_code: Optional[ApiErrorCode] = Field(default=None, alias="errorCode")
    error_details: Optional[StrictStr] = Field(default=None, alias="errorDetails")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "errorCode", "errorDetails"]
