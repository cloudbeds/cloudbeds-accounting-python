...
class RoutingRuleTransactionTypeResponse(BaseModel):
    """
    ...
    origin_id: Optional[StrictStr] = Field(default=None, description="Origin ID for the transaction type (e.g., fee ID, tax ID)", alias="originId")
    __properties: ClassVar[List[str]] = ["externalRelationKind", "originId"]
