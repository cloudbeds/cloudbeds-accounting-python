...
class AccountsReceivableLedgerTotalsResponse(BaseModel):
    """
    Aggregated totals across all matching accounts receivable ledgers.
    """ # noqa: E501
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of all charges across matching AR ledgers, in the smallest currency unit.")
    paid: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of all payments across matching AR ledgers, in the smallest currency unit.")
    balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of outstanding balances across matching AR ledgers (total minus paid), in the smallest currency unit.")
    __properties: ClassVar[List[str]] = ["total", "paid", "balance"]
