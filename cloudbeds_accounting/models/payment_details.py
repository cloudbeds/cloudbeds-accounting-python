...
class PaymentDetails(BaseModel):
    ...
    """ # noqa: E501
    transaction_type: Optional[StrictStr] = Field(default=None, description="Payment processing transaction type", alias="transactionType")
    payment_method: Optional[StrictStr] = Field(default=None, description="Payment method code (e.g. \"cash\", \"cards\", \"terminal\", \"ebanking\", \"pay_pal\", \"oxxo\")", alias="paymentMethod")
    gateway: Optional[StrictStr] = Field(default=None, description="Payment gateway identifier (e.g. \"StripeConnectGateway\", \"AdyenGateway\")")
    credit_card_type: Optional[StrictStr] = Field(default=None, description="Card brand code (e.g. \"visa\", \"master\", \"amex\")", alias="creditCardType")
    card_trailing_digits: Optional[StrictStr] = Field(default=None, description="Last 4 digits of the card number", alias="cardTrailingDigits")
    amount_paid: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total captured/paid amount", alias="amountPaid")
    amount_refunded: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total refunded amount", alias="amountRefunded")
    processing_status: Optional[StrictStr] = Field(default=None, description="Payment processing status (for scheduled payments)", alias="processingStatus")
    __properties: ClassVar[List[str]] = ["transactionType", "paymentMethod", "gateway", "creditCardType", "cardTrailingDigits", "amountPaid", "amountRefunded", "processingStatus"]
    ...
    def transaction_type_validate_enum(cls, value):
        ...
        _allowed_values = set(['Purchase', 'Capture', 'Refund', 'Authorize', 'Void', 'Record', 'unknown_default_open_api'])
    ...
    def processing_status_validate_enum(cls, value):
        ...
        _allowed_values = set(['unconfirmed', 'confirmed', 'unknown_default_open_api'])
        if value not in _allowed_values:
            return 'unknown_default_open_api'
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cardTrailingDigits": obj.get("cardTrailingDigits"),
