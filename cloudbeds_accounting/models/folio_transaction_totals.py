...
class FolioTransactionTotals(BaseModel):
    """
    Global totals across all matching transactions (all pages).
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Total number of matching transactions")
    total_debit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of all debit amounts in smallest currency unit", alias="totalDebit")
    total_credit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of all credit amounts in smallest currency unit", alias="totalCredit")
    currency: Optional[StrictStr] = Field(default=None, description="Property currency ISO code")
    currency_scale: Optional[StrictInt] = Field(default=None, alias="currencyScale")
    __properties: ClassVar[List[str]] = ["count", "totalDebit", "totalCredit", "currency", "currencyScale"]
