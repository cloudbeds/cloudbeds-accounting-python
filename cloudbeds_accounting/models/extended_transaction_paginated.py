...
class ExtendedTransactionPaginated(BaseModel):
    """
    ExtendedTransactionPaginated
    """ # noqa: E501
    content: Optional[List[ExtendedTransactionResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [ExtendedTransactionResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
