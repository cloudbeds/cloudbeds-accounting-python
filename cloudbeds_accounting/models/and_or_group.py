...
class AndOrGroup(BaseModel):
    """
    AndOrGroup
    """ # noqa: E501
    var_and: Optional[List[AndOrGroupAndInner]] = Field(default=None, alias="and")
    var_or: Optional[List[AndOrGroupAndInner]] = Field(default=None, alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [AndOrGroupAndInner.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None,
            "or": [AndOrGroupAndInner.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
        return _obj

from cloudbeds_accounting.models.and_or_group_and_inner import AndOrGroupAndInner
# TODO: Rewrite to not use raise_errors
AndOrGroup.model_rebuild(raise_errors=False)
