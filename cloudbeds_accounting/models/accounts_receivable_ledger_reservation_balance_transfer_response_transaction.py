...
class AccountsReceivableLedgerReservationBalanceTransferResponseTransaction(BaseModel):
    """
    AccountsReceivableLedgerReservationBalanceTransferResponseTransaction
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Posted transaction id")
