...
class FolioConfigurationFolioData(BaseModel):
    """
    FolioConfigurationFolioData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    folio_name: Optional[StrictStr] = Field(default=None, alias="folioName")
    link_type: Optional[StrictInt] = Field(default=None, description="Converted to SourceKind", alias="linkType")
    transaction_types: Optional[List[FolioConfigurationFolioTransactionTypeData]] = Field(default=None, alias="transactionTypes")
    __properties: ClassVar[List[str]] = ["id", "folioName", "linkType", "transactionTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "folioName": obj.get("folioName"),
            "linkType": obj.get("linkType"),
            "transactionTypes": [FolioConfigurationFolioTransactionTypeData.from_dict(_item) for _item in obj["transactionTypes"]] if obj.get("transactionTypes") is not None else None
        })
        return _obj
