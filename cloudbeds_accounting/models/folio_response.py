...
class FolioResponse(BaseModel):
    ...
    FolioResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Folio ID")
    name: Optional[StrictStr] = Field(default=None, description="Folio name")
    property_id: Optional[StrictStr] = Field(default=None, description="Property ID", alias="propertyId")
    folio_configuration_id: Optional[StrictStr] = Field(default=None, description="Folio configuration ID", alias="folioConfigurationId")
    parent_id: Optional[StrictStr] = Field(default=None, description="Parent folio ID (null for root folios)", alias="parentId")
    source_id: Optional[StrictStr] = Field(default=None, description="Source ID (reservation ID, group profile ID, or config ID)", alias="sourceId")
    source_kind: Optional[FolioSourceKind] = Field(default=None, alias="sourceKind")
    transaction_types: Optional[List[FolioTransactionTypeResponse]] = Field(default=None, description="Transaction types assigned to this folio", alias="transactionTypes")
    __properties: ClassVar[List[str]] = ["id", "name", "propertyId", "folioConfigurationId", "parentId", "sourceId", "sourceKind", "transactionTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "folioConfigurationId": obj.get("folioConfigurationId"),
            "parentId": obj.get("parentId"),
            "sourceId": obj.get("sourceId"),
            "sourceKind": obj.get("sourceKind"),
            "transactionTypes": [FolioTransactionTypeResponse.from_dict(_item) for _item in obj["transactionTypes"]] if obj.get("transactionTypes") is not None else None
        })
        return _obj
