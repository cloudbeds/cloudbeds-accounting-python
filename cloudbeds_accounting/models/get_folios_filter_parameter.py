...
class GetFoliosFilterParameter(BaseModel):
    """
    GetFoliosFilterParameter
    """ # noqa: E501
    source_id: StrictInt = Field(description="Filter by source ID", alias="sourceId")
    source_kind: FolioSourceKind = Field(alias="sourceKind")
    __properties: ClassVar[List[str]] = ["sourceId", "sourceKind"]
