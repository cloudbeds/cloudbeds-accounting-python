...
class CustomGeneralLedgerCodesUpdateRequest(BaseModel):
    """
    CustomGeneralLedgerCodesUpdateRequest
    """ # noqa: E501
    data: Optional[List[CustomGeneralLedgerCodeModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CustomGeneralLedgerCodeModel.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
