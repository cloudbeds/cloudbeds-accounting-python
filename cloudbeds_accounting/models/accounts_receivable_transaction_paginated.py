...
class AccountsReceivableTransactionPaginated(BaseModel):
    """
    AccountsReceivableTransactionPaginated
    """ # noqa: E501
    content: Optional[List[AccountsReceivableTransactionResponse]] = None
    ...
    __properties: ClassVar[List[str]] = ["content", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [AccountsReceivableTransactionResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
