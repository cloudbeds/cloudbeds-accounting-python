...
class PostGroupProfileBalanceTransferRequest(BaseModel):
    """
    PostGroupProfileBalanceTransferRequest
    """ # noqa: E501
    folio_id: Optional[StrictInt] = Field(default=None, description="Group profile folio ID", alias="folioId")
    __properties: ClassVar[List[str]] = ["folioId"]
