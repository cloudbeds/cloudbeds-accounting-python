...
class FolioConfigurationData(BaseModel):
    """
    ...
    sources: Optional[List[FolioConfigurationSourceData]] = None
    folios: Optional[List[FolioConfigurationFolioData]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "isDefault", "updatedAt", "sources", "folios"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in folios (list)
        _items = []
        if self.folios:
            for _item_folios in self.folios:
                if _item_folios:
                    _items.append(_item_folios.to_dict())
            _dict['folios'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sources": [FolioConfigurationSourceData.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None,
            "folios": [FolioConfigurationFolioData.from_dict(_item) for _item in obj["folios"]] if obj.get("folios") is not None else None
        })
        return _obj
