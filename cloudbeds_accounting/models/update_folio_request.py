...
class UpdateFolioRequest(BaseModel):
    ...
    transaction_types: Optional[List[TransactionTypeIdentifier]] = Field(default=None, description="Transaction types to assign to this folio", alias="transactionTypes")
    __properties: ClassVar[List[str]] = ["name", "transactionTypes"]
